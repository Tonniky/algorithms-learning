...
public class MultiThread {
    ...
    public static void main(String[] args) {
        Map<String, LinkedBlockingQueue<String>> multiMap = new ConcurrentHashMap<>();
        ThreadGroup group = new ThreadGroup("thread1");
        ThreadLocal threadLocal = new ThreadLocal<HttpServletResponse>();
        for (int i = 0; i < 10; i++) {
            String str = "111";
            multiMap.put(i,str);
        ...
        for (int i = 0; i < 10; i++) {
            new Thread(group, new Runnable() {
                ...
                public void run() {
                    ...
                    LinkedBlockingQueue<String> consumerQueue = multiMap.get(i);
